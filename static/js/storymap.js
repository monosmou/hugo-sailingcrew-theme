(function ( $ ) {
    ...
    var onThumbnailsClick = function(e) {
        ...
        if(!clickedListItem) {
            // open the first image if we're somewhere inside a gallery
            while (eTarget.tagName.toUpperCase() != 'BODY') {
                eTarget = eTarget.parentNode;
                var uid = eTarget.getAttribute('data-pswp-uid');
                if (uid) {
                    openPhotoSwipe(0, eTarget);
                }
            }
